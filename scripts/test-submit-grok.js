    ...
    try {
        ...
        if (submitResult.evaluation) {
            ...
            if (submitResult.evaluation.tokenomics_recommendation) {
                ...
                console.log('   Eligible epochs:', submitResult.evaluation.tokenomics_recommendation.eligible_epochs?.join(', ') || 'None');
                console.log('   Suggested allocation:', submitResult.evaluation.tokenomics_recommendation.suggested_allocation || 'N/A');
                console.log('   Tier multiplier:', submitResult.evaluation.tokenomics_recommendation.tier_multiplier || 'N/A');
                console.log('   Requires admin approval:', submitResult.evaluation.tokenomics_recommendation.requires_admin_approval ? 'Yes' : 'No');
            }
