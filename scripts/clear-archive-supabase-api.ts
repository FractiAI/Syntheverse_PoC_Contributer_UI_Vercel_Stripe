...
const SUPABASE_URL = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://jfbgdxeumzqzigptbmvp.supabase.co'
const SUPABASE_SERVICE_ROLE_KEY = process.env.SUPABASE_SERVICE_ROLE_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImpmYmdkeGV1bXpxemlncHRibXZwIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2NjA4NzM4OCwiZXhwIjoyMDgxNjYzMzg4fQ.-2HxO5TMcWFv21Ax4GZMqjTuJz-okIujHQx-R2xrTnY'
...
async function clearPoCArchive() {
    try {
        ...
        const contributionsAfter = contributionsAfterRes.headers.get('content-range')?.split('/')[1] || '0'
