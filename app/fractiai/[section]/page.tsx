...
> = {
  ...
  vortex: {
    ...
    paragraphs: [
      ...
      '“12D” here is not a gimmick—it’s a reminder that the frontier is multi‑axis: coherence, novelty, density, alignment, compositional assay, epoch timing, and more. The map must respect dimensionality without becoming unreadable.',
      'The noir style is functional: heavy keylines and negative space prevent signal collapse; gilded accents mark discoveries without turning the interface into noise.',
      'Cartography is governance by clarity. When the map is legible, incentives become understandable; when incentives are understandable, people build the right things; when people build the right things, the frontier compounds.',
      'In Syntheverse, the Cartographer’s role is to keep the system navigable as it grows—so the ecosystem can scale without losing meaning.',
    ],
  },
  contact: {
    label: 'CONTACT',
