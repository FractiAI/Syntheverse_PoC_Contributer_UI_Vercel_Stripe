...
import { getBaseMainnetConfig, createBaseProvider } from '@/utils/blockchain/base-mainnet-integration'
        ...
        return NextResponse.json(
            {
                ...
                message: 'Failed to check gas balance. Check network connectivity and environment variables.'
            },
            { status: 500 }
        )
    }
