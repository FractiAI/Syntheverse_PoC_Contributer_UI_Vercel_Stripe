          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="cockpit-text text-sm opacity-80">
                Traditional hierarchical systems waste 38–58% of resources on management overhead in simulated models. Time- and role-indexed allocations decouple cost from value creation. Creators and enterprises face high operational burn rates with low innovation density. Contributions remain hidden, unverifiable, and controlled by gatekeeping.
              </p>
            </div>
          </div>
        </Card>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="cockpit-text mb-3 text-sm opacity-80">
              <strong>Syntheverse delivers the highest-output, lowest-cost system currently achievable.</strong> Validated in simulated models: <strong>1.5–1.8× higher coherent output per node</strong> with <strong>38–58% reduction in overhead</strong>. Contribution-indexed rewards outperform time- or role-indexed allocations. Resources deploy only where value is created.
            </p>
            <p className="cockpit-text text-sm opacity-80">
