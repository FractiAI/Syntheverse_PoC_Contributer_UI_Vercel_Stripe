      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="space-y-6 lg:col-span-2">
            ...
            <div className="border-l-4 border-[var(--hydrogen-amber)] bg-gradient-to-br from-slate-900 to-slate-800 p-6 md:p-8 shadow-lg">
              <div className="cockpit-label mb-6" style={{ color: '#ffb84d' }}>
                SUPPORT THE FRONTIER & GET ACCESS
              </div>
              <div className="cockpit-text mb-6 text-sm">
                Help build the holographic hydrogen fractal frontier while gaining access to advanced tools and supporting independent research.
              </div>

              <div className="grid gap-6 md:grid-cols-2 mb-8">
                {/* Monthly Access Plans */}
                <div className="border-2 border-slate-700 bg-slate-800/50 p-6">
                  <div className="text-xs font-bold uppercase tracking-wider text-[var(--hydrogen-beta)] mb-3">
                    SOFTWARE ACCESS
                  </div>
                  <div className="space-y-4">
                    <div className="border-l-4 border-[var(--hydrogen-beta)] bg-[var(--hydrogen-beta)]/10 p-4">
                      <div className="font-bold text-white mb-2">SynthScan™ MRI Access</div>
                      <div className="text-sm text-slate-300 mb-3">
                        Direct access to the SynthScan™ MRI evaluation system. Submit unlimited contributions.
                      </div>
                      <div className="flex items-baseline gap-2 mb-3">
                        <span className="text-2xl font-bold text-[var(--hydrogen-beta)]">$50</span>
                        <span className="text-sm text-slate-400">/month</span>
                      </div>
                      <Link 
                        href="/subscribe?product=synthscan-monthly"
                        className="inline-flex items-center justify-center gap-2 w-full border-2 border-[var(--hydrogen-beta)] bg-[var(--hydrogen-beta)]/20 px-4 py-2 text-xs font-bold uppercase tracking-wider text-[var(--hydrogen-beta)] transition-all hover:bg-[var(--hydrogen-beta)] hover:text-slate-950"
                      >
                        Subscribe
                    ...
                    <div className="border-l-4 border-[var(--hydrogen-gamma)] bg-[var(--hydrogen-gamma)]/10 p-4">
                      <div className="font-bold text-white mb-2">FieldScan™ Expert Support</div>
                      <div className="text-sm text-slate-300 mb-3">
                        Full-service evaluation with expert FractiAI operator support. We handle everything.
                      </div>
                      <div className="flex items-baseline gap-2 mb-3">
                        <span className="text-2xl font-bold text-[var(--hydrogen-gamma)]">$500</span>
                        <span className="text-sm text-slate-400">/evaluation</span>
                      </div>
                      <Link 
                        href="/subscribe?product=fieldscan-expert"
                        className="inline-flex items-center justify-center gap-2 w-full border-2 border-[var(--hydrogen-gamma)] bg-[var(--hydrogen-gamma)]/20 px-4 py-2 text-xs font-bold uppercase tracking-wider text-[var(--hydrogen-gamma)] transition-all hover:bg-[var(--hydrogen-gamma)] hover:text-slate-950"
                      >
                        Learn More
                        <ArrowRight className="h-3 w-3" />
                      </Link>
                ...
                {/* Financial Support */}
                <div className="border-2 border-slate-700 bg-slate-800/50 p-6">
                  <div className="text-xs font-bold uppercase tracking-wider text-[var(--metal-copper)] mb-3">
                    FINANCIAL SUPPORT
                  </div>
                  <div className="space-y-3">
                    <div className="border-l-4 border-[var(--metal-copper)] bg-[var(--metal-copper)]/10 p-3">
                      <div className="flex items-center justify-between mb-2">
                        <span className="font-bold text-[var(--metal-copper)]">🪙 Copper Support</span>
                        <span className="text-lg font-bold text-[var(--metal-copper)]">$25</span>
                      </div>
                      <p className="text-xs text-slate-300">Support independent frontier research</p>
                    </div>

                    <div className="border-l-4 border-[var(--metal-silver)] bg-[var(--metal-silver)]/10 p-3">
                      <div className="flex items-center justify-between mb-2">
                        <span className="font-bold text-[var(--metal-silver)]">🛡️ Silver Support</span>
                        <span className="text-lg font-bold text-[var(--metal-silver)]">$100</span>
                      </div>
                      <p className="text-xs text-slate-300">Help expand the HHF ecosystem</p>
                    </div>

                    <div className="border-l-4 border-[var(--metal-gold)] bg-[var(--metal-gold)]/10 p-3">
                      <div className="flex items-center justify-between mb-2">
                        <span className="font-bold text-[var(--metal-gold)]">👑 Gold Support</span>
                        <span className="text-lg font-bold text-[var(--metal-gold)]">$500</span>
                      </div>
                      <p className="text-xs text-slate-300">Accelerate holographic hydrogen fractal awareness</p>
                    </div>

                    <Link 
                      href="/support"
                      className="inline-flex items-center justify-center gap-2 w-full mt-4 border-2 border-[var(--hydrogen-amber)] bg-[var(--hydrogen-amber)]/20 px-4 py-3 text-xs font-bold uppercase tracking-wider text-[var(--hydrogen-amber)] transition-all hover:bg-[var(--hydrogen-amber)] hover:text-slate-950"
                    >
              ...
              <div className="border-t border-slate-700 pt-4 text-xs text-slate-400">
                <strong>Note:</strong> All payments support frontier research and infrastructure. SYNTH tokens are internal coordination units for protocol accounting only—not investments, securities, or financial instruments.
              </div>
            </div>
