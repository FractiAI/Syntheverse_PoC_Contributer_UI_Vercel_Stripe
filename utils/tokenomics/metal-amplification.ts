...
export function calculateMetalAmplification(metals: string[]): MetalAmplificationResult {
  ...
  if (hasGold && hasSilver && hasCopper) {
    return {
      ...
      description:
        'Full Integration (Gold + Silver + Copper): 1.5× amplification for maximum cross-disciplinary integration',
    };
  }
  ...
  if (hasGold && hasSilver) {
    return {
      ...
      description:
        'Gold + Silver: 1.25× amplification for integrated Research + Technology contributions',
    };
  }
  ...
  if (hasGold && hasCopper) {
    return {
      ...
      description:
        'Gold + Copper: 1.2× amplification for ecosystem-aligned Research + Alignment work',
    };
  }
  ...
  if (hasSilver && hasCopper) {
    return {
      ...
      description:
        'Silver + Copper: 1.15× amplification for balanced Development + Alignment contributions',
    };
  }
