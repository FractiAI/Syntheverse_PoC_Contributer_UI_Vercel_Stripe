// NOTE: This prompt is intentionally long and "mythic-scientific".
// It is used as the Grok system prompt to anchor the Syntheverse PoC evaluation persona and requirements.
//
// IMPORTANT: Keep edits deliberate — token budget issues should be addressed by shrinking the user prompt
