-- =====================================================
-- SOCIAL MEDIA PANEL SETUP - COPY & PASTE INTO SUPABASE SQL EDITOR
-- =====================================================
-- Run this entire script in Supabase Dashboard → SQL Editor
-- This creates all tables, indexes, RLS policies, and triggers for social media functionality
-- =====================================================

-- STEP 1: Create social_posts table
...
-- STEP 2: Create social_post_likes table
...
-- STEP 3: Create social_post_comments table
...
-- STEP 5: Add profile_picture_url to users_table
...
-- STEP 7: RLS Policies for social_posts
...
-- STEP 10: Function to update likes_count when likes are added/removed
...
-- STEP 11: Trigger to automatically update likes_count
DROP TRIGGER IF EXISTS trigger_update_post_likes_count ON public.social_post_likes;
CREATE TRIGGER trigger_update_post_likes_count
  AFTER INSERT OR DELETE ON public.social_post_likes
  FOR EACH ROW
  EXECUTE FUNCTION update_post_likes_count();

-- STEP 12: Function to update comments_count when comments are added/removed
...
-- STEP 13: Trigger to automatically update comments_count
DROP TRIGGER IF EXISTS trigger_update_post_comments_count ON public.social_post_comments;
...
-- =====================================================
-- DONE! Tables, indexes, RLS policies, and triggers created.
-- =====================================================
-- 
-- NEXT STEP: Create Storage Buckets (must be done in Supabase Dashboard):
-- 
...
--    - Allowed MIME types: image/*
-- 
-- 5. Set up Storage RLS Policies (in Storage → Policies):
--    - social-media-images: Allow authenticated upload, public read
--    - profile-pictures: Allow authenticated upload, public read
-- =====================================================
